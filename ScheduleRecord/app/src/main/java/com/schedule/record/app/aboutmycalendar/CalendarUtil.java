    ...
    public String toString() {
        ...
        if (StringUtil.isNullOrEmpty(message)) {
            ...
            if (!StringUtil.isNullOrEmpty(solarMsg)) {
                message =  CHINESE_NUMBER[mLuchMonth - 1] + "月"+ getChinaDayString(mLuchDay)+" "+solarMsg;
            } else {
                /**
                 * 判断当前日期是否为公历节日
                 */
                ...
                if (!StringUtil.isNullOrEmpty(gremessage)) {
                    message = CHINESE_NUMBER[mLuchMonth - 1] + "月"+getChinaDayString(mLuchDay)+" "+gremessage;
                } else {
                    message = CHINESE_NUMBER[mLuchMonth - 1] + "月"+getChinaDayString(mLuchDay);
                }
