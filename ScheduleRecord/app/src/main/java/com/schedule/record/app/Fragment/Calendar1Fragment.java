...
//    }
    ...
    public void onResume1() {
        ...
        CalenderDayAdapter adapter = new CalenderDayAdapter(getContext(),dataList,mode1ProgressBar);
        int countBar = dao.CountBar();
        Toast.makeText(getContext(),"已完成数量为："+countBar,Toast.LENGTH_SHORT).show();
